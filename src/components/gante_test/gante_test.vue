  ...
  export default{
    mounted(){
      let data=[
        {
          gunter_id:1,
          params:{title:'项目制作任务',startTime:'2018-12-17',endTime:'2019-1-3',biaoti:'这是任务标题内容'},
          start_time:new Date(2018,11,17).getTime(),
          end_time:new Date(2019,0,3).getTime(),
          level:1,
          children:[
      ...
      th_data = {
        ...
        endTime:{value:'结束时间',width:150,showToast:true,chooseTime:true,time_mode:2},
        biaoti:{value:'内容',width:450,shrink:true,showToast:true,edit:true}}
      this.$gante({container:'.gante',ganteData:data,start_time:new Date('2018/12/15').getTime(),end_time:new Date('2019/2/4').getTime(),open:true,height:400,time_mode:1,th_data:th_data})
      console.log(111)
    },
  }
</script>
