	...
	export default{
		...
		mounted(){
			let data=[
						...
						{
							gunter_id:3,
							params:{title:'项目制作任务1',startTime:'2018-12-19',endTime:'2019-1-4',biaoti:'这是任务标题内容'},
							start_time:new Date(2018,11,19).getTime(),
						...
						{
							gunter_id:6,
							params:{title:'项目制作任务2',startTime:'',endTime:'2019-1-5',biaoti:'这是任务标题内容'},
							start_time:0,
							end_time:new Date(2019,0,5).getTime(),
							level:1,
							children:[
								{
									gunter_id:7,
						...
						{
							gunter_id:8,
							params:{title:'项目制作任务3',startTime:'',endTime:'2019-1-6',biaoti:'这是任务标题内容'},
							start_time:0,
							end_time:new Date(2019,0,6).getTime(),
							level:1,
							children:[
								{
									gunter_id:9,
					...
					th_data = {
						title:{value:'任务名称',width:80,showToast:false,listen_click:true},
						startTime:{value:'开始时间',width:150,showToast:true,chooseTime:true,time_mode:1,sort_type: 'asc'},
						endTime:{value:'结束时间',width:150,showToast:true,chooseTime:true,time_mode:2,sort_type: 'asc'},
						biaoti:{value:'内容',width:450,shrink:true,showToast:true,edit:true}},
					loadData = [{
						gunter_id:9,
						params:{title:'项目制作任务',startTime:'',endTime:'2019-1-3',biaoti:'这是任务标题内容'},
